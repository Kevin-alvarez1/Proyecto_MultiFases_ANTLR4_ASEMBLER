...
func (v *BasegramaticaVisitor) VisitStructDef(ctx *StructDefContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitAtributos(ctx *AtributosContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitStructInst(ctx *StructInstContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitStructInit(ctx *StructInitContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitListaStructs(ctx *ListaStructsContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitAccesoStruct(ctx *AccesoStructContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitAsigStruct(ctx *AsigStructContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitFunStruct(ctx *FunStructContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitCaja(ctx *CajaContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitValores(ctx *ValoresContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BasegramaticaVisitor) VisitActStruct(ctx *ActStructContext) interface{} {
	return v.VisitChildren(ctx)
}
