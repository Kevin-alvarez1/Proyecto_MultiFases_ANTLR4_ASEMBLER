...
func (s *BasegramaticaListener) EnterStructDef(ctx *StructDefContext) {}

// ExitStructDef is called when production structDef is exited.
func (s *BasegramaticaListener) ExitStructDef(ctx *StructDefContext) {}

// EnterAtributos is called when production atributos is entered.
func (s *BasegramaticaListener) EnterAtributos(ctx *AtributosContext) {}

// ExitAtributos is called when production atributos is exited.
func (s *BasegramaticaListener) ExitAtributos(ctx *AtributosContext) {}

// EnterStructInst is called when production structInst is entered.
func (s *BasegramaticaListener) EnterStructInst(ctx *StructInstContext) {}

// ExitStructInst is called when production structInst is exited.
func (s *BasegramaticaListener) ExitStructInst(ctx *StructInstContext) {}

// EnterStructInit is called when production structInit is entered.
func (s *BasegramaticaListener) EnterStructInit(ctx *StructInitContext) {}

// ExitStructInit is called when production structInit is exited.
func (s *BasegramaticaListener) ExitStructInit(ctx *StructInitContext) {}

// EnterListaStructs is called when production listaStructs is entered.
func (s *BasegramaticaListener) EnterListaStructs(ctx *ListaStructsContext) {}

// ExitListaStructs is called when production listaStructs is exited.
func (s *BasegramaticaListener) ExitListaStructs(ctx *ListaStructsContext) {}

// EnterAccesoStruct is called when production accesoStruct is entered.
func (s *BasegramaticaListener) EnterAccesoStruct(ctx *AccesoStructContext) {}

// ExitAccesoStruct is called when production accesoStruct is exited.
func (s *BasegramaticaListener) ExitAccesoStruct(ctx *AccesoStructContext) {}

// EnterAsigStruct is called when production asigStruct is entered.
func (s *BasegramaticaListener) EnterAsigStruct(ctx *AsigStructContext) {}

// ExitAsigStruct is called when production asigStruct is exited.
func (s *BasegramaticaListener) ExitAsigStruct(ctx *AsigStructContext) {}

// EnterFunStruct is called when production funStruct is entered.
func (s *BasegramaticaListener) EnterFunStruct(ctx *FunStructContext) {}

// ExitFunStruct is called when production funStruct is exited.
func (s *BasegramaticaListener) ExitFunStruct(ctx *FunStructContext) {}

// EnterCaja is called when production caja is entered.
func (s *BasegramaticaListener) EnterCaja(ctx *CajaContext) {}

// ExitCaja is called when production caja is exited.
func (s *BasegramaticaListener) ExitCaja(ctx *CajaContext) {}
...
// EnterActStruct is called when production actStruct is entered.
func (s *BasegramaticaListener) EnterActStruct(ctx *ActStructContext) {}

// ExitActStruct is called when production actStruct is exited.
func (s *BasegramaticaListener) ExitActStruct(ctx *ActStructContext) {}
